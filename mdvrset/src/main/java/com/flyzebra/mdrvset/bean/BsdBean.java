...
public class BsdBean {
    ...
    public BsdInfo toBsdInfo(BsdBean bsdBean) {
        ...
        bsdInfo.highDangerLine_startPoint_x = Math.min(Config.CAM_WIDTH, bsdInfo.highDangerLine_startPoint_x);
        ...
        bsdInfo.highDangerLine_startPoint_y = Math.min(Config.CAM_HEIGHT, bsdInfo.highDangerLine_startPoint_y);
        ...
        bsdInfo.highDangerLine_endPoint_x = Math.min(Config.CAM_WIDTH, bsdInfo.highDangerLine_endPoint_x);
        ...
        bsdInfo.highDangerLine_endPoint_y = Math.min(Config.CAM_HEIGHT, bsdInfo.highDangerLine_endPoint_y);
        ...
        bsdInfo.mediumDangerLine_startPoint_x = Math.min(Config.CAM_WIDTH, bsdInfo.mediumDangerLine_startPoint_x);
        ...
        bsdInfo.mediumDangerLine_startPoint_y = Math.min(Config.CAM_HEIGHT, bsdInfo.mediumDangerLine_startPoint_y);
        ...
        bsdInfo.mediumDangerLine_endPoint_x = Math.min(Config.CAM_WIDTH, bsdInfo.mediumDangerLine_endPoint_x);
        ...
        bsdInfo.mediumDangerLine_endPoint_y = Math.min(Config.CAM_HEIGHT, bsdInfo.mediumDangerLine_endPoint_y);
        ...
        bsdInfo.lowDangerLine_startPoint_x = Math.min(Config.CAM_WIDTH, bsdInfo.lowDangerLine_startPoint_x);
        ...
        bsdInfo.lowDangerLine_startPoint_y = Math.min(Config.CAM_HEIGHT, bsdInfo.lowDangerLine_startPoint_y);
        ...
        bsdInfo.lowDangerLine_endPoint_x = Math.min(Config.CAM_WIDTH, bsdInfo.lowDangerLine_endPoint_x);
        ...
        bsdInfo.lowDangerLine_endPoint_y = Math.min(Config.CAM_HEIGHT, bsdInfo.lowDangerLine_endPoint_y);
        return bsdInfo;
    }
